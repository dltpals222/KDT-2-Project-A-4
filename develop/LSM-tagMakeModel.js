...
var companyNo = companyInner.map(function (value) { return value.no; });
var companyOpen = companyInner.map(function (value) { return value.open; });
var companyHigh = companyInner.map(function (value) { return value.high; });
var companyLow = companyInner.map(function (value) { return value.low; });
var companyClose = companyInner.map(function (value) { return value.close; });
var companyVolume = companyInner.map(function (value) { return value.volume; });
var companyDay = companyInner.map(function (value) { return value.day; });
